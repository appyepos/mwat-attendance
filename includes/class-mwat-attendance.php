...
final class MWAT_Attendance {
    ...
    private function how_it_works_screen() {
        echo '<div class="mwat-intro"><h3>How It Works</h3><p>The attendance system is designed to run automatically alongside the way you already manage walks on the website.</p></div>';
